...
class UserSessionController extends ChangeNotifier {
  ...
  Future<void> _run(Future<void> Function() action) async {
    ...
    message = null;
    notifyListeners();
    try { await action(); } on ApiException catch (exception) { error = exception.message; } catch (_) { error = 'تعذر تنفيذ عملية جلسة التمرين.'; } finally { isLoading = false; notifyListeners(); }
  }
}
