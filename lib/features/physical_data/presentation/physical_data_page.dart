    ...
    return Scaffold(
      ...
      body: AnimatedBuilder(animation: widget.controller, builder: (_, __) => ListView(padding: const EdgeInsets.all(16), children: [
        ...
        _section('Body information', [
          ...
          DropdownButtonFormField<PhysicalSex>(value: PhysicalSex.values.contains(_sex) ? _sex : null, decoration: const InputDecoration(labelText: 'Gender'), items: PhysicalSex.values.map((sex) => DropdownMenuItem(value: sex, child: Text(sex.label))).toList(growable: false), onChanged: (value) => setState(() => _sex = value)),
